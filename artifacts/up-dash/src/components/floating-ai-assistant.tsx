...
export function FloatingAiAssistant() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    newMessage(
      "assistant",
      "Oi. Eu consulto os dados da loja selecionada. Pode perguntar, por exemplo: faturamento de ontem, produtos mais vendidos nos últimos 7 dias ou cadastros de 28/05.",
    ),
  ]);
            ...
            <div className="flex items-center justify-between border-b border-border px-5 py-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground">Dados da loja selecionada</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
